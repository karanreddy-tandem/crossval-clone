                ...
                <Row className="card-body">
                  ...
                  <Col xs="4" className="text-right">
                    <h4 className="num total-value">
                      {"$"}
                      <span className="counter">{"3654"}</span>
                      {".00"}
                    </h4>
                  </Col>
                </Row>
          ...
          <Col xl="4" md="12" className="box-col-12">
            <Card className="o-hidden">
              <div className="chart-widget-top">
                <Row className="card-body">
                  <Col xs="8">
                    <h6 className="f-w-600 font-success">{PROJECTS}</h6>
                    <span className="num">
                  ...
                  <Col xs="4" className="text-right">
                    <h4 className="num total-value">
                      <span className="counter">{"12569"}</span>
                    </h4>
                  </Col>
                </Row>
                <div>
                  ...
                  <Row className="text-center f-w-600">
                    <Col xs="4" className="b-r-light">
                      <div>
                        ...
                        <h4 className="num m-0">
                          <span className="counter color-bottom">{"3659"}</span>
                          {"M"}
                        </h4>
                      </div>
                    </Col>
                    <Col xs="4" className="b-r-light">
                      <div>
                        ...
                        <h4 className="num m-0">
                          <span className="counter color-bottom">{"698"}</span>
                          {"M"}
                        </h4>
                      </div>
                    </Col>
                    <Col xs="4">
                      <div>
                        ...
                        <h4 className="num m-0">
                          <span className="counter color-bottom">{"9361"}</span>
                          {"M"}
                        </h4>
                      </div>
                    </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="chart-widget13">
                    <Chart
                      options={browserUses.options}
                      series={browserUses.series}
                      height="500"
                      type="candlestick"
                    />
                  </div>
