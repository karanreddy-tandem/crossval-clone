...
import HistoricalData from "../components/dashboard/historical-data";
import CapTables from "../components/dashboard/cap-tables";
...
import Breakeven from "../components/dashboard/breakeven";
...
export const routes = [
  { path: "/dashboard/general", Component: General },
  { path: "/dashboard/revenue", Component: Revenue },
  { path: "/dashboard/expenses", Component: Expenses },
  { path: "/dashboard/inputs", Component: Inputs },
  { path: "/dashboard/historical-data", Component: HistoricalData },
  { path: "/dashboard/cap-tables", Component: CapTables },
  { path: "/dashboard/valuation", Component: Valuation },
  { path: "/dashboard/income-statement", Component: IncomeStatement },
  { path: "/dashboard/cash-flow", Component: CashFlow },
  { path: "/dashboard/breakeven", Component: Breakeven },
