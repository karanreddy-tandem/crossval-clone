import { List, GitPullRequest } from "react-feather";
export const MENUITEMS = [
  {
    ...
    Items: [
      ...
      {
        path: `${process.env.PUBLIC_URL}/dashboard/revenue`,
        title: "Revenue",
        type: "link",
        icon: GitPullRequest,
      },
      {
        path: `${process.env.PUBLIC_URL}/dashboard/expenses`,
        title: "Expenses",
        type: "link",
        icon: GitPullRequest,
      },
      {
        path: `${process.env.PUBLIC_URL}/dashboard/inputs`,
        title: "Inputs",
        type: "link",
        icon: GitPullRequest,
      },
      {
        path: `${process.env.PUBLIC_URL}/dashboard/historical-data`,
        title: "Historical Data",
        type: "link",
        icon: GitPullRequest,
      },
      {
        path: `${process.env.PUBLIC_URL}/dashboard/cap-tables`,
        title: "Cap Tables",
        type: "link",
        icon: GitPullRequest,
      },
      {
        ...
        children: [
          {
            path: `${process.env.PUBLIC_URL}/dashboard/valuation`,
            title: "Valuation",
            type: "link",
          },
          {
            path: `${process.env.PUBLIC_URL}/dashboard/income-statement`,
            title: "Income Statement",
            type: "link",
          },
          {
            path: `${process.env.PUBLIC_URL}/dashboard/cash-flow`,
            title: "Cash Flow",
            type: "link",
          },
          {
            path: `${process.env.PUBLIC_URL}/dashboard/breakeven`,
            title: "Breakeven",
            type: "link",
          },
          // {
